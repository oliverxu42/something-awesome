  ...
  return (
    <ArticleLayout>
      ...
      <ul className='list-disc list-outside pl-6 pt-3'>
        <li>
          access unauthorised sensitive data from a database (such as passwords,
          credit card details, personal information...)
        </li>
        <li>
          modify the data within the database through INSERT, UPDATE and DELETE
          queries
        </li>
        <li>
      ...
      <p>
        ...
        student is identified via an id (e.g. "1234567") and contains some data
        (their name, age, grade). <br />
      ...
      <p>
        ...
        since we 'OR' this with their name, the conditional will always be true!
        So, this query instead of just returning a list of students with the
        name "Bob", it will actually return EVERY user in the database!
      </p>
      <div>
        <h2>Try it out!</h2>

  ...
  return (
    <ArticleLayout>
      ...
      <p>
        ...
        attacker can inject malicious scripts into a vulnerable application. XSS
        works by manipulating a website so that it can execute malicious
      ...
      <h2>Reflected XSS</h2>
      <p>
        Reflected cross-site scripting occurs in an application when a malicious
        script is "reflected" off the web server, e.g. through a search query:
      </p>
      <CodeBlock
        lines={[
      ...
      />
      <p>
        An attacker can inject malicious javascript within the query parameter:
      </p>
      <CodeBlock
        lines={[
      ...
      <p>
        ...
        browser. The browser then executes the code because it appeared to come
        from a “trusted” site.
      </p>
      <h2>Stored XSS</h2>
      <p>
